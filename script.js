...
! function(t) {
    ...
    function _t(t) {
        ...
        r.dispatch((0, _.instanceAdded)((0, a.default)({
            ...
            skipMotion: S,
            skipToValue: n
        }, o))), mt(document.body, "ix2-animation-started", g), f ? function(t, e) {
    ...
    function yt(t, e) {
        ...
        var n = t.elementId,
            ...
            o = i.ref;
        i.refType === A && B(o, r, y), e.dispatch((0, _.instanceRemoved)(t.id))
    }
    ...
    n(130), n(132), n(133), n(134), n(135), n(69), n(137), n(332), n(333), n(334), n(335), t.exports = n(340)
}, function(t, e, n) {
    "use strict";
    var r = n(4);
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        switch (n.actionTypeId) {
            ...
            case at:
                ...
                if (p === B) {
                    var m = c(e, P);
                    s(e, P, ""), E = f(e, "offsetHeight"), s(e, P, m)
                }
                return {
            ...
            case st:
                var I = n.config,
                    ...
                    w = I.aValue;
                return {
                    rValue: T, gValue: b, bValue: O, aValue: w
                };
            case it:
            ...
            case K:
                return function(t, e, n, r, i) {
                    var o = Ct.map(function(t) {
                        ...
                        a = i.setStyle;
                    Pt(t, _.TRANSFORM_PREFIXED, i), a(t, _.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === J && void 0 !== d || s === tt && void 0 !== d || s === et && (void 0 !== f || void 0 !== l)) && a(t, _.TRANSFORM_STYLE_PREFIXED, R);
                    var u, c, s, f, l, d
                }(t, e, n, i, a);
            case q:
                    ...
                    switch (r.actionTypeId) {
                        ...
                        case st:
                            var h = pt[r.actionTypeId],
                                ...
                                y = n.aValue;
                            Pt(t, h, o), a(t, h, y >= 1 ? "rgb(".concat(E, ",").concat(g, ",").concat(_, ")") : "rgba(".concat(E, ",").concat(g, ",").concat(_, ",").concat(y, ")"));
                            break;
                        default:
                            var m = r.config.unit,
                                I = void 0 === m ? "" : m;
    ...
    var f = s(n(270)),
        ...
        vt = Object.freeze((i = {}, (0, c.default)(i, _.TRANSFORM_PREFIXED, I), (0, c.default)(i, M, m), (0, c.default)(i, x, x), (0, c.default)(i, C, C), (0, c.default)(i, D, D), (0, c.default)(i, P, P), (0, c.default)(i, L, L), i)),
        ht = {},
        Et = 1;
    var gt = 1;
    var _t = function(t, e) {
    ...
    function mt(t) {
        ...
        var N, x, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || O] || {},
            ...
            P = o && l(yt(o.target));
        if (D ? (N = L.limitAffectedElements, x = P, C = l(L)) : x = C = l({
                id: T,
                selector: O,
                selectorGuids: w
            }), o && S) {
        ...
        T = function(t, e) {
            ...
            for (var S = 0, R = i.length; S < R; S++) {
                ...
                if (0 === S && (_ = C[0]), A >= x) {
                    ...
                    var L = i[S + 1],
                        D = L && A !== x;
                    m = D ? L.actionItems[0] : null, D && (I = x / 100, T = (L.keyframe - x) / 100)
                }
            }
            var P = {};
            if (_ && !m)
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function m(e, n) {
                ...
                ! function(e, n) {
                    ...
                    function O(t) {
                        var r = t.responseJSON && t.responseJSON.msg,
                            i = m;
                        "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = y : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = _), p.text(i), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), s.toggle(!0), s.focus(), n.fileUploads[e].uploading = !1, S() || I(n)
                    }
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), _.test(s) ? i.handler = A : s || (o ? i.handler = w : y())
        }
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "6418cf2ad06441867507c1d5|e878babd-15c4-fba3-339d-82bbf2818c2f"
                        },
                        "value": 0,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "6418cf2ad06441867507c1d5|e58a40fe-b78e-7225-1265-1135c9e323e7"
                        },
                        "value": 0,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "6418cf2ad06441867507c1d5|e8b7b23e-7f7c-a0ec-0660-1b2c6276ddd0"
                        },
                        "value": 0,
                        "unit": ""
                    }
